//
//  UserTimelineTableViewCell.swift
//  TwitterClient
//
...
protocol UserTimelineTableViewCellDelegate: class {
    func userTimelineTableViewCell(_ cell: UserTimelineTableViewCell, didTapLinkWith url: URL)
}

class UserTimelineTableViewCell: UITableViewCell {
    ...
    weak var delegate: UserTimelineTableViewCellDelegate?
...
// MARK: - public
extension UserTimelineTableViewCell {
...
extension UserTimelineTableViewCell: TTTAttributedLabelDelegate {
    func attributedLabel(_ label: TTTAttributedLabel!, didSelectLinkWith url: URL!) {
        delegate?.userTimelineTableViewCell(self, didTapLinkWith: url)
    }
}
